...
$host = 'localhost'; // for testing from host machine (since ports are exported)
$user = 'devuser';
$pass = 'devpass';
...
try {
    ...
    // Kassa batch message test based on the contracts
    $xmlData = <<<XML
...
<KassaBatch>
    ...
    <users>
        <user>
            <!-- Assuming this matches a Client 'aid' in FOSSBilling -->
